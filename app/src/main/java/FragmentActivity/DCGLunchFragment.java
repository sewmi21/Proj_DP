...
import Item.Item;
import adapter.lunchAdapter;



public class DCGLunchFragment extends Fragment {
    ...
    public void loadDatabase() {
        ...
        try {
            cursor = databaseHelper.QueryData("select * from DiabeticsCholesterolGastritisL");
            if (cursor != null) {
        ...
        adapter = new lunchAdapter(getActivity(),arrayList);
