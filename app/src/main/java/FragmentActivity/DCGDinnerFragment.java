...
import Item.Item;
import adapter.dinnerAdapter;



public class DCGDinnerFragment extends android.support.v4.app.Fragment {
    ...
    public void loadDatabase() {
        ...
        try {
            cursor = databaseHelper.QueryData("select * from DiabeticsCholesterolGastritisD");
            if (cursor != null) {
        ...
        adapter = new dinnerAdapter(getActivity(),arrayList);
