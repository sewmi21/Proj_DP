...
import adapter.DGViewPagerAdapter;
import adapter.DViewPagerAdapter;


public class DGDietResultActivity extends AppCompatActivity {
    private Toolbar toolbar;
    private TabLayout tabLayout;
    private ViewPager viewPager;
    private DGViewPagerAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dgdiet_result);
        initView();
        initToolbar();
        initTabLayout();
        setupView();
    ...
    public void setupView() {
        adapter = new DGViewPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
