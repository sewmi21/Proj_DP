...
public class DietPlanActivity extends AppCompatActivity {
    ...
    private Button btn ,rest_btn,diet_btn,exercises_btn,statics_btn,cross_btn,viewpage,dieabticsBtn,CholestroleBtn,GastritisBtn,DiechoBtn,CholGasBtn,GasDieaBtn,DiGaChoBtn,checkBtn,extraMealBtn;
    private CheckBox diabetic,cholestrol,gastritis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        extraMealBtn.setOnClickListener(new View.OnClickListener() {
            ...
            startActivity(new Intent(DietPlanActivity.this,ExtraMealActivity.class));
            }
        });
        ...
        dieabticsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(DietPlanActivity.this,DDietResultActivity.class));
        ...
        CholestroleBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
             startActivity(new Intent(DietPlanActivity.this,DietResultActivity.class));
        ...
        GastritisBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
            startActivity(new Intent(DietPlanActivity.this,GDietResultActivity.class));
            }
        });
        ...
        DiechoBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
            startActivity(new Intent(DietPlanActivity.this,DCDietResultActivity.class));
            }
        });
        ...
        CholGasBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              startService(new Intent(DietPlanActivity.this,CGDietResultActivity.class));
            }
        });
        ...
        GasDieaBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
             startActivity(new Intent(DietPlanActivity.this,DGDietResultActivity.class));
            }
        });
        ...
        DiGaChoBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              startActivity(new Intent(DietPlanActivity.this,DCGDietResultActivity.class));
            }
        });
        ...
        checkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if((cholestrol.isChecked())&& (!gastritis.isChecked())&& (!diabetic.isChecked())){
                ...
                else if((diabetic.isChecked())&&(!gastritis.isChecked())&&(!cholestrol.isChecked())){
                ...
                else if((gastritis.isChecked())&&(!diabetic.isChecked())&&(!cholestrol.isChecked())){
                    dieabticsBtn.setVisibility(View.INVISIBLE);
                    CholestroleBtn.setVisibility(View.INVISIBLE);
                    GasDieaBtn.setVisibility(View.INVISIBLE);
                ...
                else if((cholestrol.isChecked())&& (gastritis.isChecked())&& (!diabetic.isChecked())){
                    dieabticsBtn.setVisibility(View.INVISIBLE);
                    CholestroleBtn.setVisibility(View.INVISIBLE);
                    GastritisBtn.setVisibility(View.INVISIBLE);
                    GasDieaBtn.setVisibility(View.INVISIBLE);
                ...
                else if((diabetic.isChecked())&&(cholestrol.isChecked())&& (!gastritis.isChecked())){
                    dieabticsBtn.setVisibility(View.INVISIBLE);
                    CholestroleBtn.setVisibility(View.INVISIBLE);
                    GastritisBtn.setVisibility(View.INVISIBLE);
                    CholGasBtn.setVisibility(View.INVISIBLE);
    ...
    public void MenuButtons(){
        ...
        rest_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(DietPlanActivity.this,MainActivity.class));
            }
        });
        ...
        diet_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DietPlanActivity.this,DietPlanFemaleActivity.class));
            }
        });
        ...
        exercises_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DietPlanActivity.this,ExercisesActivity.class));
        ...
        statics_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DietPlanActivity.this,CaloriesActivity.class));
            }
        });
