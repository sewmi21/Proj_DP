...
import adapter.GViewPagerAdapter;

public class GDietResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gdiet_result);
    ...
    public void setupView() {
        adapter = new GViewPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
