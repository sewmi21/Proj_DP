...
import adapter.DCViewPagerAdapter;


public class DCDietResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dcdiet_result);
        initView();
        initToolbar();
        initTabLayout();
        setupView();
    ...
    public void setupView() {
        adapter = new DCViewPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
