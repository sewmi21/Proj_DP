...
import adapter.PViewPagerAdapter;

public class PDietResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdiet_result);
        initView();
        initToolbar();
        initTabLayout();
        setupView();
    ...
    public void setupView() {
        adapter = new PViewPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
